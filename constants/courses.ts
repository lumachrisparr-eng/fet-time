...
function lvl(code: string): number {
  const n = parseInt(code.replace(/[A-Z]/g, ''), 10);
...
export const COURSES: Course[] = raw.map(c => ({ ...c, level: lvl(c.code) }));
